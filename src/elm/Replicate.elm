...
type alias SubEvent =
    GenEffect.SubEvent ReplicateEvent
...
type alias ReplicateType msg =
    GenEffect.ChangeType ReplicateEvent msg


type MySub msg
    = Replicate (ReplicateType msg)


type alias Process msg =
    GenEffect.Process ReplicateEvent msg
