effect module Events
    where { subscription = MySub }
    exposing
        ( ListenEvent(Created, Destroyed)
        , new
        )
...
type alias SubEvent =
    GenEffect.SubEvent ListenEvent
...
type alias NativeStart =
    GenEffect.NativeStart ListenEvent


type alias Tagger msg =
    GenEffect.Tagger ListenEvent msg
...
type alias ListenType msg =
    GenEffect.ChangeType ListenEvent msg


type MySub msg
    = Listen (ListenType msg)


type alias Process msg =
    GenEffect.Process ListenEvent msg
