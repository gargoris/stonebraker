...
type alias SubEvent =
    GenEffect.SubEvent ChangeEvent
...
type alias NativeStart =
    GenEffect.NativeStart ChangeEvent


type alias Tagger msg =
    GenEffect.Tagger ChangeEvent msg
...
type alias ChangeType msg =
    GenEffect.ChangeType ChangeEvent msg


type MySub msg
    = Change (ChangeType msg)


type alias Process msg =
    GenEffect.Process ChangeEvent msg
