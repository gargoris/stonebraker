    ...
    let
        valDoc =
            case doc.doc of
                ...
                Nothing ->
                    Result.Err "trying to decode empty payload"
    in
        case valDoc of
            Result.Ok value ->
                Result.Ok
